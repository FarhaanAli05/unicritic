...
Unicritic is a **Next.js web application** that aggregates ratings and reviews from **multiple platforms** (IMDb, Rotten Tomatoes, Letterboxd, and others) into a single unified score called the **"Uniscore."**
